...
<tr>
   ...
   <h2> :fire: Список связей</h2>
    <table>
      ...
      <tr>
         <td rowspan="2"><b>UserDorm (пользователь <i>ЖИВЁТ</i> в общежитии)</b></td>
      ...
      <tr>
        <td rowspan="2"><b>UserRoom (пользователь <i>ЖИВЁТ</i> в комнате)</b></td>
        <td><i>Пользователь</i></td>
      ...
      <tr>
        <td rowspan="2"><b>RoomDorm (комната <i>НАХОДИТСЯ</i> в общежитии)</b></td>
        <td><i>Комната</i></td>
      ...
      <tr>
        <td rowspan="2"><b>UserOffers (пользователь <i>ОБМЕНИВАЕТ</i> товары)</b></td>
        <td><i>Пользователь</i></td>
      ...
      <tr>
        <td rowspan="2"><b>Bargains (сделка <i>ВЛЮЧАЕТ</i> обмен товарами)</b></td>
        <td><i>Сделка</i></td>
