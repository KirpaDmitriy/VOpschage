...
<table>
    ...
    <tr>
        <td><i>IS App</i></td>
        <td>Архитектура очень близка к требуемой, приложжение рассматривает пользователя, как студента, фокусируется на важных для задач вещах, хранит ключевые данные, сосредоточено на удовлетворение отребностей практически той же целевой аудитории</td>
